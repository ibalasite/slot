...
|:----:|:---:|:---------:|:-------------:|:------:|
| 1 | ×3 | 80% | `oklch(60% 0.16 145)` #2E8B57 | 連接 1→2：`--color-fg-blue` |
| 2 | ×7 | 68% | `oklch(72% 0.14 226)` #00BFFF | 連接 2→3：`oklch(78% 0.17 88)` 黃 |
...
> 進度線從綠→藍→黃→橙→紅漸進，對應 Heads 機率 80%→68%→56%→48%→40%，視覺傳達難度遞增。
...
|---------|-----------|-----------|------|
| ×3 → ×7 | `oklch(60% 0.16 145)` 綠 | `oklch(72% 0.14 226)` 藍 | 進度線段色漸變 |
| ×7 → ×17 | `oklch(72% 0.14 226)` 藍 | `oklch(75% 0.18 65)` 黃橙 | |
...
- [ ] FG 進度條 5 個節點色彩依 §4.8 / §7.3 精確規格（綠→藍→黃→橙→紅）
